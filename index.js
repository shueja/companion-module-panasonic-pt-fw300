...
class PanasonicInstance extends InstanceBase {
	...
	getConfigFields() {
		return [
			...
			},
			{
				...
				label: 'Protocol Mode',
				choices: [
					{ id: ntcontrol.ProtocolMode.Auto, label: 'Auto' },
					{ id: ntcontrol.ProtocolMode.Persistent, label: 'Persistent' },
					{ id: ntcontrol.ProtocolMode.SingleCommand, label: 'Single command' },
				],
				default: ntcontrol.ProtocolMode.Auto,
			},
		]
	}
	...
	createConnection(config) {
		const obj = new ntcontrol.Client(config.host, config.port, undefined, undefined, config.protocolMode)
	...
	async configUpdated(config) {
		const resetConnection =
			...
			config.protocolMode !== this.config.protocolMode ||
